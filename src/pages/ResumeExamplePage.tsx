    ...
    <div className="min-h-screen bg-white bg-[radial-gradient(#0F766E0a_1px,transparent_1px)] [background-size:18px_18px] pt-24 pb-20 relative overflow-hidden font-sans text-[#1C2B33]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8 text-left">
            <div className="relative bg-white/40 backdrop-blur-xl border border-white/85 rounded-3xl p-6 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.02)] overflow-hidden">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-3.5 bg-white/20 backdrop-blur-xs p-5 rounded-2xl border border-stone-200/20">
                    {example.sampleExperience.map((exp, index) => (
                      <div key={index} className="flex gap-3 text-xs sm:text-sm items-start">
                        ...
                        <p className="text-[#46504D] leading-relaxed">{exp}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <h3 className="font-serif text-lg font-black text-[#1C2B33] mb-3 flex items-center gap-2">
                    <Award size={16} className="text-[#0F766E]/75" />
                    Measurable Accomplishments
                  </h3>
                  <div className="space-y-2.5 bg-white/20 backdrop-blur-xs p-5 rounded-2xl border border-stone-200/20">
                    {example.keyAchievements.map((achievement, index) => (
                      <div key={index} className="flex items-start gap-2.5 text-xs sm:text-sm">
                        <span className="text-[#0F766E] mt-1 font-black">•</span>
                        <p className="text-[#46504D] leading-relaxed">{achievement}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="relative bg-white/40 backdrop-blur-xl border border-white/80 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-[0_15px_35px_rgba(15,118,110,0.04)] overflow-hidden">
              ...
              <div className="text-center sm:text-left z-10">
                <h4 className="font-serif text-lg font-black text-[#1C2B33] tracking-tight">Apply this resume style today</h4>
          ...
          {/* Right Sidebar: Related Resume Examples */}
          <div className="space-y-6 text-left">
            ...
            <div className="bg-white/40 backdrop-blur-xl border border-white/80 rounded-3xl p-6 text-xs text-[#46504D] space-y-3 shadow-[0_10px_30px_rgba(0,0,0,0.02)]">
              <h4 className="font-mono font-bold text-[#1C2B33] uppercase tracking-wider">SEO Architecture</h4>
